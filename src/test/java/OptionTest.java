...
public class OptionTest extends TestSetUp {
    ...
    public void testRelease() throws InterruptedException {
        Contract contract = new USStockContract("AAPL");
        //contract
       // String USER_ID = "DU2048440";
        //m_client.reqPositions();
        //Thread.sleep(4000);

       // m_client.reqPnLSingle(1001, USER_ID, "", contract.conid());
        //Thread.sleep(2000);
    }
    //@Test
...
//FtpDownloader ftpDownloader = new FtpDownloader();
   ...
   // @Test
    public void test() throws InterruptedException {
        ...
        wrapper.getClient().reqMktData(1200,new USStockContract("AAPL"), "101", false, false, null);
        Thread.sleep(1000);
        System.out.println("OUTTTT==" + wrapper.getLastPrice());
    }
